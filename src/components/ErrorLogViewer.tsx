...
const ErrorLogViewer: React.FC<ErrorLogViewerProps> = ({ className = '' }) => {
  ...
  return (
    <>
      ...
      {shouldShowWindow && (
        <div
          className="absolute right-0 top-full mt-2 w-96 max-h-64 bg-white border border-gray-200 rounded-lg shadow-lg z-50"
